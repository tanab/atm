...
class Stemmer {
    private:
        ...
        ItemTypes m_type;                  //!< The type of data to be extracted.
        bool m_all_details;                //!< Indicates whether a detailed solution if the input is required or not.
        bool m_call_everything;            //!< Idicates whether all machines are to be called based on user input.
        ...
        /// Vector containing the final result of suffixes of a word and their details based on a single
        /// interpretation of the input word.
